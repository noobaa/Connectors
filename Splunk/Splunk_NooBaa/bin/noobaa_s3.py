...
class MyScript(smi.Script):
    ...
    def get_scheme(self):
        ...
        scheme = smi.Scheme("NooBaa S3")
        scheme.description = ("Collect and index log files stored in NooBaa.")
    ...
    def validate_input(self, definition):
        ...
        logger.error("connect to s3_host_name "+s3_host_name+" key "+key_id)
